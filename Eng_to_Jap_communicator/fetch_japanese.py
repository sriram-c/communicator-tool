...
with open(fname3,'r') as file1:
        ...
        for string in lines:
                line1=string.split(',')
                split_lines.append(line1)       #to put all concept dictionary entries in list seprated by comma
...
for item in string_str: 
	for string1 in line1:
		...
		if (item ==  wrd):
		#	print string1
			replaceAll('jap_facts.txt',string1.split(',')[1],string1.split(',')[2].replace('\n',''))
